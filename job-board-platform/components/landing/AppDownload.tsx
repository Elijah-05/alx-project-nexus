...
export default function AppDownload() {
  return (
    <section className="relative w-full bg-[#EAF0F7] pt-10 lg:px-[5%] lg:pt-24 overflow-hidden">
      <div className="max-w-7xl mx-auto relative flex flex-col-reverse">
        ...
        <div className="lg:absolute lg:top-1/3 lg:right-[5%] max-lg:text-center lg:-translate-y-1/2 max-w-lg max-lg:mb-14 max-lg:mx-auto">
          <h2 className="text-2xl md:text-3xl xL:text-4xl max-lg:mb-3 font-extrabold text-gray-900 leading-tight mb-2">
            Download the <br />
            <span className="">Job Listing App</span> Today!
          </h2>

          <p className="text-gray-600 text-base max-w-[90%] max-lg:mx-auto leading-relaxed mb-8">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-4">
            {/* APP STORE */}
            <button className="flex justify-center items-center gap-3 bg-gray-700 text-white px-5 py-3 rounded-xl max-w-sm lg:px-8 hover:bg-gray-900 transition">
              <Image
